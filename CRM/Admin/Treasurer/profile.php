...
<html lang="en">
  ...
  <head>
      ...
      <title>Profile | KFBCL - Mircofinance</title>

      <link rel="icon" href="../../../assets/favicon.ico">
      <link href="../../../assets/style.css" rel="stylesheet">
  </head>

  <body x-data="{ page: 'profile', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false, 'isProfileEditNextKinModal': false, 'isProfileInfoModal': false,  'isProfileContactModal': false, 'isProfileNextKinModal': false, 'isProfileAddressModal': false, 'isDeleteModalOpen': false }"
    x-init="
        ...
        <main>
          <div class="mx-auto max-w-(--breakpoint-2xl) p-4 pb-20 md:p-6 md:pb-6">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 lg:p-6 dark:border-gray-800 dark:bg-white/[0.03]">
              <h3 class="mb-5 text-lg font-semibold text-gray-800 lg:mb-7 dark:text-white/90">User: #USR0023</h3>
                  ...
                  <div class="flex w-full flex-col items-center gap-6 xl:flex-row">
                    ...
                    <div class="order-3 xl:order-2">
                      ...
                      <div class="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Treasurer</p>
                  ...
                  <div class="overflow-x-auto pb-2 sm:w-[280px] [&amp;::-webkit-scrollbar-thumb]:rounded-full [&amp;::-webkit-scrollbar-thumb]:bg-gray-100 dark:[&amp;::-webkit-scrollbar-thumb]:bg-gray-600 [&amp;::-webkit-scrollbar-track]:bg-white dark:[&amp;::-webkit-scrollbar-track]:bg-transparent [&amp;::-webkit-scrollbar]:h-1.5">
                    <nav class="flex w-full flex-row sm:flex-col sm:space-y-2">
                      <button 
                        ...
                        class="inline-flex items-center gap-3 whitespace-nowrap rounded-lg px-3 py-2.5 text-sm font-medium transition-colors duration-200 ease-in-out sm:p-3 bg-brand-50 text-brand-600 dark:bg-brand-500/10 dark:text-brand-400">
                      ...
                      <button 
                        ...
                        class="inline-flex items-center gap-3 whitespace-nowrap rounded-lg px-3 py-2.5 text-sm font-medium transition-colors duration-200 ease-in-out sm:p-3 text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700">
                          <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <tr>
                            ...
                            <td class="px-6 py-4">
                              <div class="flex items-center gap-3">
                                <button 
                                  @click="isProfileEditNextKinModal = true"
                                    ...
                                    <div>
                                      ...
                                      <div class="relative" x-data="{ showPassword: false }">
                                        <input 
                                          ...
                                          :class="errors.currentPassword ? 'border-error-500 focus:border-error-500 focus:ring-error-500/10' : 'border-gray-300 dark:border-gray-700'"
                                      ...
                                      <p x-show="errors.currentPassword" x-text="errors.currentPassword" class="text-theme-xs text-error-500 mt-1.5"></p>
                                    </div>
                                    ...
                                    <div>
                                      ...
                                      <div class="relative" x-data="{ showPassword: false }">
                                        <input 
                                          ...
                                          @input="validateNewPassword(); clearError('newPassword')"
                                          :class="errors.newPassword ? 'border-error-500 focus:border-error-500 focus:ring-error-500/10' : 'border-gray-300 dark:border-gray-700'"
                                          class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                                        />
                                        <span @click="showPassword = !showPassword" class="absolute top-1/2 right-4 z-30 -translate-y-1/2 cursor-pointer">
                                            <svg x-show="!showPassword" class="fill-gray-500 dark:fill-gray-400" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      ...
                                      <p x-show="errors.newPassword" x-text="errors.newPassword" class="text-theme-xs text-error-500 mt-1.5"></p>
                                    </div>
                                    ...
                                    <div>
                                      ...
                                      <div class="relative" x-data="{ showPassword: false }">
                                        <input 
                                          ...
                                          @input="validateConfirmPassword(); clearError('confirmPassword')"
                                          :class="errors.confirmPassword ? 'border-error-500 focus:border-error-500 focus:ring-error-500/10' : 'border-gray-300 dark:border-gray-700'"
                                          class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                                        />
                                        <span @click="showPassword = !showPassword" class="absolute top-1/2 right-4 z-30 -translate-y-1/2 cursor-pointer">
                                          <svg x-show="!showPassword" class="fill-gray-500 dark:fill-gray-400" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      ...
                                      <p x-show="errors.confirmPassword" x-text="errors.confirmPassword" class="mt-1 text-sm text-error-500"></p>
                                    </div>
                                ...
                                <div class="flex gap-3">
                                  <div class="order-3 xl:order-2">
                                    ...
                                    <div class="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                                      ...
                                      <p 
                                        :class="requirements.minLength ? 'text-success-500' : 'flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400'"
                                        class="text-sm"
                                      >
                                      ...
                                      <!-- Special character -->
                                      <p 
                                        :class="requirements.specialChar ? 'text-success-500' : 'flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400'"
                                        class="text-sm"
                                      >
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M13.4017 4.35986L6.12166 11.6399L2.59833 8.11657" stroke="#abadac" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                      ...
                                      <p 
                                        :class="requirements.numbers ? 'text-success-500' : 'flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400'"
                                        class="text-sm"
                                      >
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M13.4017 4.35986L6.12166 11.6399L2.59833 8.11657" stroke="#abadac" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path>
                                      ...
                                      <!-- Conform Password -->
                                      <p 
                                        :class="requirements.matchPassword ? 'text-success-500' : 'flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400'"
                                        class="text-sm"
                                      >
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M13.4017 4.35986L6.12166 11.6399L2.59833 8.11657" stroke="#abadac" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path>
                          ...
                          <div class="flex items-center justify-between border-t border-gray-200 p-5 dark:border-gray-800">
                            ...
                            <div x-data="{ switcherToggle: false }">
                              <button 
                                ...
                                class="shadow-theme-xs inline-flex items-center justify-center gap-2 rounded-lg bg-white px-4 py-3 text-sm font-medium text-error-700 ring-1 ring-error-300 transition hover:bg-gray-50 dark:bg-error-700 dark:text-error-400 dark:ring-gray-700 dark:hover:bg-white/[0.03]">
                                Delete Account
                              </button>
                            </div>
                          </div>
    ...
    <div x-show="isProfileEditNextKinModal" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999">
      <div class="modal-close-btn fixed inset-0 h-full w-full bg-gray-400/50 backdrop-blur-[32px]"></div>
