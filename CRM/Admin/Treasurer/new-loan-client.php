...
<html lang="en">
  ...
  <head>
      ...
      <title>New Client | KFBCL - Mircofinance</title>

      <link rel="icon" href="../../../assets/favicon.ico">
      <link href="../../../assets/style.css" rel="stylesheet">
  </head>

  <body x-data="{ page: 'profile', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false, 'isModalOpen': false, 'isProfileInfoModal': false,  'isProfileContactModal': false, 'isProfileNextKinModal': false, 'isProfileAddressModal': false }"
    x-init="
      ...
      <div class="relative flex flex-1 flex-col overflow-x-hidden overflow-y-auto">
        ...
        <main>
          <div class="mx-auto max-w-(--breakpoint-2xl) p-4 pb-20 md:p-6 md:pb-6">
            <!-- Breadcrumb Start -->
            <div x-data="{ pageName: `New Loan Applicant`}">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 lg:p-6 dark:border-gray-800 dark:bg-white/[0.03]">
              <h3 class="mb-5 text-lg font-semibold text-gray-800 lg:mb-7 dark:text-white/90">New Loan Applicant</h3>
              ...
              <div class="border-t border-gray-100 p-4 sm:p-6 dark:border-gray-800">
                <div x-data="{
                  ...
                  steps: [
                    ...
                    { id: 2, title: 'Addresses', completed: false },
                    { id: 3, title: 'Contact Information', completed: false },
                    { id: 4, title: 'Next of Kin Information', completed: false },
                    { id: 5, title: 'Preview', completed: false }
                  ],
                  goToStep(step) {
                        ...
                        <span class="absolute top-1/2 left-4 -translate-y-1/2 text-gray-500 dark:text-gray-400">
                          ...
                          <svg class="stroke-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="flex items-center justify-between px-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                              ...
                              <div x-show="currentStep === 5" class="flex items-center gap-3">
                                <button type="button"
                                        @click="prevStep()"
                                        class="flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-6 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03]">
                                  Cancel
        ...
        <div class="text-center">
          ...
          <div class="flex items-center justify-center w-full gap-3 mt-7">
            <button
                    ...
                    onclick="window.location.href='loans.php'"
                    type="button"
