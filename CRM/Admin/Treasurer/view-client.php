...
<html lang="en">
  ...
  <head>
      ...
      <title>View Client | KFBCL - Mircofinance</title>

      <link rel="icon" href="../../../assets/favicon.ico">
      <link href="../../../assets/style.css" rel="stylesheet">
  </head>

  <body x-data="{ page: 'profile', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false, 'isModalOpen': false, 'makeDepositModal': false,  'isProfileInfoModal': false,  'isProfileAddressModal': false,  'isProfileContactModal': false, 'isProfileNextKinModal': false, 'isProfileGuarantorModal': false,  'isProfileFinancialModal': false, 'addAssetModal': false, 'verifyPaymentModal': false }"
    x-init="
      ...
      <div class="relative flex flex-1 flex-col overflow-x-hidden overflow-y-auto">
        ...
        <main>
          <div class="mx-auto max-w-(--breakpoint-2xl) p-4 pb-20 md:p-6 md:pb-6">
            <!-- Breadcrumb Start -->
            <div x-data="{ pageName: `Loan Client`}">
              <div class="flex flex-wrap items-center justify-between gap-3 pb-6">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90" x-text="pageName"></h2>
                <nav>
                  <ol class="flex items-center gap-1.5">
                    <li>
                      <a class="inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400" href="loans.php">Loans Dashboard
                        <svg
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 lg:p-6 dark:border-gray-800 dark:bg-white/[0.03]">
              <h3 class="mb-5 text-lg font-semibold text-gray-800 lg:mb-7 dark:text-white/90">Client: #LA001</h3>
              ...
              <div class="mb-6 flex relative grid grid-cols-1 gap-6 sm:grid-cols-1 lg:grid-cols-1">
                <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
                  <div class="mb-6 flex justify-between">
                    <div>
                      <h3 class="text-lg font-semibold text-warning-700 dark:text-white/90">
                        Loans
                      </h3>
                      <p class="text-theme-sm mt-1 text-gray-500 dark:text-gray-400">
                        Pending Loan Balance
                      </p>
                      <h3 class="text-2xl font-semibold text-gray-500 dark:text-white/90">
                        KES 23,500.00
                      </h3>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center justify-center gap-6">
                        <div>
                          ...
                          <p class="text-theme-sm font-semibold mt-0.5 text-center text-success-700 dark:text-gray-400">
                            Contributed
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p class="text-theme-sm mt-0.5 font-semibold text-center text-error-500 dark:text-gray-400">
                            Withdrawn
                          </p>
                        </div>
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <button @click="makeDepositModal = true"
                            ...
                            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 18h14M5 18v3h14v-3M5 18l1-9h12l1 9M16 6v3m-4-3v3m-2-6h8v3h-8V3Zm-1 9h.01v.01H9V12Zm3 0h.01v.01H12V12Zm3 0h.01v.01H15V12Zm-6 3h.01v.01H9V15Zm3 0h.01v.01H12V15Zm3 0h.01v.01H15V15Z"></path>
                            </svg>
                            Make Payment
                      </button>
                    </div>
                  ...
                  <div class="overflow-x-auto pb-2 sm:w-[280px] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-100 dark:[&::-webkit-scrollbar-thumb]:bg-gray-600 [&::-webkit-scrollbar-track]:bg-white dark:[&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar]:h-1.5">
                    <nav class="flex w-full flex-row sm:flex-col sm:space-y-2">
                      ...
                      <button @click="activeTab = 'addresses'"
                              :class="activeTab === 'addresses' ? 'bg-brand-50 text-brand-600 dark:bg-brand-500/10 dark:text-brand-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'"
                              class="inline-flex items-center gap-3 whitespace-nowrap rounded-lg px-3 py-2.5 text-sm font-medium transition-colors duration-200 ease-in-out sm:p-3">
                        <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button @click="activeTab = 'contact'"
                              :class="activeTab === 'contact' ? 'bg-brand-50 text-brand-600 dark:bg-brand-500/10 dark:text-brand-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'"
                              class="inline-flex items-center gap-3 whitespace-nowrap rounded-lg px-3 py-2.5 text-sm font-medium transition-colors duration-200 ease-in-out sm:p-3">
                        <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button @click="activeTab = 'next-of-kin'"
                              :class="activeTab === 'next-of-kin' ? 'bg-brand-50 text-brand-600 dark:bg-brand-500/10 dark:text-brand-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'"
                              class="inline-flex items-center gap-3 whitespace-nowrap rounded-lg px-3 py-2.5 text-sm font-medium transition-colors duration-200 ease-in-out sm:p-3">
                        <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button @click="activeTab = 'guarantors'"
                              :class="activeTab === 'guarantors' ? 'bg-brand-50 text-brand-600 dark:bg-brand-500/10 dark:text-brand-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'"
                              class="inline-flex items-center gap-3 whitespace-nowrap rounded-lg px-3 py-2.5 text-sm font-medium transition-colors duration-200 ease-in-out sm:p-3">
                        <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div class="flex-1">
                    ...
                    <div x-show="activeTab === 'contact'">
                      ...
                      <div class="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                        ...
                        <button @click="isProfileContactModal = true"
                                class="shadow-theme-xs flex w-full items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-6 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-800 sm:w-auto dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                          <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M15.0911 2.78206C14.2125 1.90338 12.7878 1.90338 11.9092 2.78206L4.57524 10.116C4.26682 10.4244 4.0547 10.8158 3.96468 11.2426L3.31231 14.3352C3.25997 14.5833 3.33653 14.841 3.51583 15.0203C3.69512 15.1996 3.95286 15.2761 4.20096 15.2238L7.29355 14.5714C7.72031 14.4814 8.11172 14.2693 8.42013 13.9609L15.7541 6.62695C16.6327 5.74827 16.6327 4.32365 15.7541 3.44497L15.0911 2.78206ZM12.9698 3.84272C13.2627 3.54982 13.7376 3.54982 14.0305 3.84272L14.6934 4.50563C14.9863 4.79852 14.9863 5.2734 14.6934 5.56629L14.044 6.21573L12.3204 4.49215L12.9698 3.84272ZM11.2597 5.55281L5.6359 11.1766C5.53309 11.2794 5.46238 11.4099 5.43238 11.5522L5.01758 13.5185L6.98394 13.1037C7.1262 13.0737 7.25666 13.003 7.35947 12.9002L12.9833 7.27639L11.2597 5.55281Z" fill=""></path>
                          </svg>
                    ...
                    <div x-show="activeTab === 'next-of-kin'">
                      ...
                      <div class="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                        ...
                        <div class="flex flex-col gap-3 sm:flex-row">
                          <button @click="isProfileNextKinModal = true"
                          ...
                          <button @click="isProfileNextOfKinModal = true"
                                  class="flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-5 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700">
                            <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div class="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
                        <div class="w-full">
                          ...
                          <p class="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
                            Manage member statisitcs easily
                          </p>
                        </div>
                    ...
                    <!-- Guarantors Table (already complete) -->
                    <div x-show="activeTab === 'guarantors'">
                      <!-- Header: Title Left + Buttons Right -->
                      <div class="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                        <h3 class="text-2xl font-semibold text-gray-800 dark:text-white/90">
                          Guarantors
                        ...
                        <div class="flex flex-col gap-3 sm:flex-row">
                          <button @click="isProfileGuarantorModal = true"
                                  class="inline-flex items-center gap-2 px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">
                            <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                            </svg>
                      ...
                      <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                          ...
                          <tr>
                            <td class="px-6 py-4">
                              <div>
                                <p class="text-sm font-medium text-gray-900 dark:text-white">Mary Wanjiku</p>
                                <p class="text-xs text-gray-500 dark:text-gray-400">mary.wanjiku@gmail.com</p>
                              </div>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">Thika Town</td>
                            <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">+254 722 987 654</td>
                            <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">Sister</td>
                            <td class="px-6 py-4">
                              <span class="bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500 rounded-full px-2 py-0.5 text-xs font-medium">Active</span>
                            </td>
                          </tr>
                    ...
                    <div x-show="activeTab === 'financials'">
                      ...
                      <div class="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
                        ...
                        <div class="w-full">
                          ...
                          <p class="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
                            Mange all client loant transactions
                          </p>
                        </div>

                        <div class="flex items-start w-full gap-2 sm:justify-end">
                          ...
                          <div class="relative z-20 bg-transparent">
                            <select class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" :class="isOptionSelected &amp;&amp; 'text-gray-800 dark:text-white/90'">
                              <option class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" selected="">Transaction</option>
                              <option value="Repayment" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Loan Repayment</option>
                              <option value="Disbursement" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Loan Disbursement</option>
                            </select>
                          ...
                          <div class="relative w-fit">
                            <select class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" :class="isOptionSelected &amp;&amp; 'text-gray-800 dark:text-white/90'">
                              <option class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" selected="">Status</option>
                              <option value="Confirmed" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Confirmed</option>
                      ...
                      <div class="flex">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                          ...
                          <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Loan</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Amount</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Transaction Type</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Transaction Date</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Status</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Actions</th>
                          </tr>
                          </thead>
                          ...
                          <tr>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">Contribution</td>
                            ...
                            <td class="px-6 py-4">
                              <div class="flex items-center gap-3">
                                <button @click="verifyPaymentModal = true"
                          ...
                          <tr>
                            <td class="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">#TRX002</td>
                            <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">Loan Disbursement</td>
                            <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">10 Dec 2025</td>
                            <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">KES 50,000</td>
                            <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">Bank Transfer</td>
                            <td class="px-6 py-4">
                              <span class="bg-warning-50 text-warning-600 dark:bg-warning-500/15 dark:text-warning-500 rounded-full px-2 py-0.5 text-xs font-medium">Pending</span>
                            </td>
                            <td class="px-6 py-4">
                              <div class="flex items-center gap-3">
                                <button class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" @click="verifyPaymentModal = true">
                                  <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                  </svg>
                                </button>
                          ...
                          <tr>
                            <td class="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">#TRX003</td>
                            <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">Withdrawal</td>
                            <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">05 Dec 2025</td>
                            <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">KES 5,000</td>
                            <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">Cash</td>
                            <td class="px-6 py-4">
                              <span class="bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500 rounded-full px-2 py-0.5 text-xs font-medium">Completed</span>
                            </td>
                            <td class="px-6 py-4">
                      ...
                      <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-3">
                        <article class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/3">
                          <div class="relative p-5 pb-9">
                            ...
                            <p class="max-w-xs text-sm text-gray-500 dark:text-gray-400">
                              Connect Mailchimp to streamline your email
                              marketing—automate campaigns.
                            </p>
                            <div x-data="{openDropDown: false}" class="absolute top-5 right-5 h-fit">
                              <button @click="openDropDown = !openDropDown" :class="openDropDown ? 'text-gray-700 dark:text-white' : 'text-gray-400 hover:text-gray-700 dark:hover:text-white'" class="text-gray-400 hover:text-gray-700 dark:hover:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                  <path d="M5 10.0044L5 9.99609M15 10.0044V9.99609M10 10.0044V9.99609" stroke="currentColor" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                              </button>
                              <div x-show="openDropDown" @click.outside="openDropDown = false" class="shadow-theme-lg dark:bg-gray-dark absolute top-full right-0 z-40 w-40 space-y-1 rounded-2xl border border-gray-200 bg-white p-2 dark:border-gray-800" style="display: none;">
                                <button @click="isDeleteModalOpen = !isDeleteModalOpen" class="text-theme-xs flex w-full rounded-lg px-3 py-2 text-left font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                                  Remove
                                </button>
                              </div>
                            </div>
                          ...
                          <div class="flex items-center justify-between border-t border-gray-200 p-5 dark:border-gray-800">
                            <div class="flex gap-3">
                              <button @click="isModalOpen = !isModalOpen" class="shadow-theme-xs inline-flex h-11 w-11 items-center justify-center rounded-lg border border-gray-300 text-gray-700 dark:border-gray-700 dark:text-gray-400">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                  ...
                                  <path d="M12.5714 9.99977C12.5714 11.4196 11.4204 12.5706 10.0005 12.5706C8.58069 12.5706 7.42969 11.4196 7.42969 9.99977C7.42969 8.57994 8.58069 7.42894 10.0005 7.42894C11.4204 7.42894 12.5714 8.57994 12.5714 9.99977Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                              </button>
                              <button @click="isDetailsModalOpen = !isDetailsModalOpen" class="shadow-theme-xs inline-flex h-11 items-center justify-center rounded-lg border border-gray-300 px-4 py-3 text-sm font-medium text-gray-700 dark:border-gray-700 dark:text-gray-400">
                                Details
                              </button>
                            </div>
                          ...
                          <div class="relative p-5 pb-9">
                            <div class="mb-5 inline-flex h-10 w-10 items-center justify-center">
                              <svg xmlns="http://www.w3.org/2000/svg" width="34" height="28" viewBox="0 0 34 28" fill="none">
                                <path d="M0.195312 25.5498C0.195312 26.7653 1.18832 27.7498 2.41179 27.7498H2.44365C1.20145 27.7498 0.195312 26.7653 0.195312 25.5498Z" fill="#FBBC05"></path>
                                <path d="M19.2427 8.49984V14.2436L26.9864 7.99752V2.44996C26.9864 1.23448 25.9933 0.25 24.7699 0.25H7.99351L7.97852 8.49984H19.2427Z" fill="#FBBC05"></path>
                                <path d="M19.2433 19.9898H7.96038L7.94727 27.7502H24.7705C25.9958 27.7502 26.987 26.7657 26.987 25.5502V20.5416L19.2433 14.2461V19.9898Z" fill="#34A853"></path>
                                <path d="M7.99331 0.25L0.195312 8.49984H7.98019L7.99331 0.25Z" fill="#EA4335"></path>
                                <path d="M0.195312 19.9893V25.5497C0.195312 26.7651 1.20145 27.7496 2.44365 27.7496H7.94647L7.95959 19.9893H0.195312Z" fill="#1967D2"></path>
                                <path d="M7.98019 8.5H0.195312V19.9893H7.95959L7.98019 8.5Z" fill="#4285F4"></path>
                                <path d="M33.7951 23.5941V4.71118C33.3586 2.20506 30.61 5.07784 30.61 5.07784L26.9883 7.99828V20.5399L32.1726 24.7546C34.0443 25.0003 33.7951 23.5941 33.7951 23.5941Z" fill="#34A853"></path>
                                <path d="M19.2422 14.2437L26.9877 20.5411V7.99951L19.2422 14.2437Z" fill="#188038"></path>
                              </svg>
                            </div>
                            <h3 class="mb-3 text-lg font-semibold text-gray-800 dark:text-white/90">
                              Google Meet
                            ...
                            <p class="max-w-xs text-sm text-gray-500 dark:text-gray-400">
                              Connect your Google Meet account for seamless video
                              conferencing.
                            </p>
                            <div x-data="{openDropDown: false}" class="absolute top-5 right-5 h-fit">
                              <button @click="openDropDown = !openDropDown" :class="openDropDown ? 'text-gray-700 dark:text-white' : 'text-gray-400 hover:text-gray-700 dark:hover:text-white'" class="text-gray-400 hover:text-gray-700 dark:hover:text-white">
                          ...
                          <div class="relative p-5 pb-9">
                            <div class="mb-5 inline-flex h-10 w-10 items-center justify-center">
                              <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.5 14.5C2.5 10.2996 2.5 8.19941 3.31745 6.59507C4.0365 5.18386 5.18386 4.0365 6.59507 3.31745C8.19941 2.5 10.2996 2.5 14.5 2.5H25.5C29.7004 2.5 31.8006 2.5 33.4049 3.31745C34.8161 4.0365 35.9635 5.18386 36.6825 6.59507C37.5 8.19941 37.5 10.2996 37.5 14.5V25.5C37.5 29.7004 37.5 31.8006 36.6825 33.4049C35.9635 34.8161 34.8161 35.9635 33.4049 36.6825C31.8006 37.5 29.7004 37.5 25.5 37.5H14.5C10.2996 37.5 8.19941 37.5 6.59507 36.6825C5.18386 35.9635 4.0365 34.8161 3.31745 33.4049C2.5 31.8006 2.5 29.7004 2.5 25.5V14.5Z" fill="#4087FC"></path>
                                <path d="M10.3333 12.5C9.45888 12.5 8.75 13.2995 8.75 14.2857V22.9464C8.75 25.4613 10.5577 27.5 12.7875 27.5L22.1667 27.4107C23.0411 27.4107 23.75 26.6113 23.75 25.625V16.875C23.75 14.3602 21.6048 12.5 19.375 12.5L10.3333 12.5Z" fill="white"></path>
                                <path d="M25.8903 15.9095C25.3244 16.469 25 17.2764 25 18.125V21.7491C25 22.5978 25.3244 23.4052 25.8903 23.9647L29.411 27.0656C30.1274 27.7739 31.25 27.2002 31.25 26.1256V13.919C31.25 12.8444 30.1274 12.2707 29.411 12.979L25.8903 15.9095Z" fill="white"></path>
                              </svg>
                            </div>
                            <h3 class="mb-3 text-lg font-semibold text-gray-800 dark:text-white/90">
                              Zoom
                            ...
                            <p class="max-w-xs text-sm text-gray-500 dark:text-gray-400">
                              Integrate Zoom to streamline your virtual meetings and team
                              collaborations
                            </p>
                            <div x-data="{openDropDown: false}" class="absolute top-5 right-5 h-fit">
                              <button @click="openDropDown = !openDropDown" :class="openDropDown ? 'text-gray-700 dark:text-white' : 'text-gray-400 hover:text-gray-700 dark:hover:text-white'" class="text-gray-400 hover:text-gray-700 dark:hover:text-white">
                        ...
                        <article class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/3">
                          <div class="relative p-5 pb-9">
                            <div class="mb-5 inline-flex h-10 w-10 items-center justify-center">
                              <svg xmlns="http://www.w3.org/2000/svg" width="34" height="26" viewBox="0 0 34 26" fill="none">
                                <path d="M25.8983 2.73975L17.0938 9.61095L8.08789 2.73975V2.7416L8.09877 2.75089V12.3724L16.9922 19.3922L25.8983 12.6436V2.73975Z" fill="#EA4335"></path>
                                <path d="M28.2107 1.06821L25.8984 2.73959V12.6434L33.1742 7.05731V3.69227C33.1742 3.69227 32.291 -1.11386 28.2107 1.06821Z" fill="#FBBC05"></path>
                                <path d="M25.8984 12.6437V25.4892H31.475C31.475 25.4892 33.0618 25.3257 33.176 23.5169V7.05762L25.8984 12.6437Z" fill="#34A853"></path>
                                <path d="M8.09918 25.4998V12.3721L8.08789 12.3628L8.09918 25.4998Z" fill="#C5221F"></path>
                                <path d="M8.08912 2.7417L5.7896 1.07961C1.70921 -1.10246 0.824219 3.70181 0.824219 3.70181V7.06685L8.08912 12.3632V2.7417Z" fill="#C5221F"></path>
                                <path d="M8.08789 2.74121V12.3628L8.09918 12.372V2.7505L8.08789 2.74121Z" fill="#C5221F"></path>
                                <path d="M0.824219 7.06836V23.5277C0.936656 25.3383 2.52529 25.4999 2.52529 25.4999H8.10182L8.08912 12.3629L0.824219 7.06836Z" fill="#4285F4"></path>
                              </svg>
                            </div>
                            <h3 class="mb-3 text-lg font-semibold text-gray-800 dark:text-white/90">
                              Gmail
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                              Integrate Gmail to send, receive, and manage emails directly
                              from your workspace.
                            </p>
                            <div x-data="{openDropDown: false}" class="absolute top-5 right-5 h-fit">
                              <button @click="openDropDown = !openDropDown" :class="openDropDown ? 'text-gray-700 dark:text-white' : 'text-gray-400 hover:text-gray-700 dark:hover:text-white'" class="text-gray-400 hover:text-gray-700 dark:hover:text-white">
                          ...
                          <div class="flex items-center justify-between border-t border-gray-200 p-5 dark:border-gray-800">
                            ...
                            <div x-data="{ switcherToggle: false }">
                              <label for="toggle6" class="cursor-pointer">
                                <div class="relative">
                                  <input type="checkbox" id="toggle6" class="sr-only" @change="switcherToggle = !switcherToggle">
                                  <div class="block h-6 w-11 rounded-full bg-gray-200 dark:bg-white/10" :class="switcherToggle ? 'bg-brand-500 dark:bg-brand-500' : 'bg-gray-200 dark:bg-white/10'"></div>
                                  <div :class="switcherToggle ? 'translate-x-full': 'translate-x-0'" class="shadow-theme-sm absolute top-0.5 left-0.5 h-5 w-5 rounded-full bg-white duration-200 ease-linear translate-x-0"></div>
                                </div>
                              </label>
                ...
                <div class="w-full px-2.5">
                  <div class="flex items-center gap-3" x-data="{ isChecked: '' }">
                    ...
                    <div class="flex flex-wrap items-center gap-4">
                      <div>
                        <label :class="isChecked === 'Free' ? 'text-gray-700 dark:text-gray-400' : 'text-gray-500 dark:text-gray-400'" class="relative flex cursor-pointer items-center gap-3 text-sm font-medium select-none text-gray-500 dark:text-gray-400">
                          ...
                          <span :class="isChecked === 'Free' ? 'border-brand-500 bg-brand-500' : 'bg-transparent border-gray-300 dark:border-gray-700'" class="flex h-5 w-5 items-center justify-center rounded-full border-[1.25px] bg-transparent border-gray-300 dark:border-gray-700">
                            <span :class="isChecked === 'Free' ? 'block' : 'hidden'" class="h-2 w-2 rounded-full bg-white hidden"></span>
                          </span>
                          Male
                        </label>
                      </div>
                      ...
                      <div>
                        <label :class="isChecked === 'Paid' ? 'text-gray-700 dark:text-gray-400' : 'text-gray-500 dark:text-gray-400'" class="relative flex cursor-pointer items-center gap-3 text-sm font-medium select-none text-gray-500 dark:text-gray-400">
                          ...
                          <span :class="isChecked === 'Paid' ? 'border-brand-500 bg-brand-500' : 'bg-transparent border-gray-300 dark:border-gray-700'" class="flex h-5 w-5 items-center justify-center rounded-full border-[1.25px] bg-transparent border-gray-300 dark:border-gray-700">
                                    <span :class="isChecked === 'Paid' ? 'block' : 'hidden'" class="h-2 w-2 rounded-full bg-white hidden"></span>
                                  </span>
                          Female
                        </label>
                      </div>
                    ...
                    <div class="w-full px-2.5 xl:w-1/2">
                      ...
                      <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                        <select class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" :class="isOptionSelected && 'text-gray-800 dark:text-white/90'" @change="isOptionSelected = true">
                          <option value="" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Select Marital Status</option>
                          <option value="single" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Single</option>
                          <option value="married" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Married</option>
                          <option value="divorced" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Divorced</option>
                          <option value="widowed" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Widowed</option>
                          <option value="separated" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Separated</option>
                        </select>
    ...
    <div x-show="isProfileGuarantorModal" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999">
      <div class="modal-close-btn fixed inset-0 h-full w-full bg-gray-400/50 backdrop-blur-[32px]"></div>
      <div @click.outside="isProfileGuarantorModal = false" class="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        <!-- close btn -->
        <button @click="isProfileGuarantorModal = false" class="transition-color absolute right-5 top-5 z-999 flex h-11 w-11 items-center justify-center rounded-full bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-gray-600 dark:bg-gray-700 dark:bg-white/[0.05] dark:text-gray-400 dark:hover:bg-white/[0.07] dark:hover:text-gray-300">
          <svg
                  class="fill-current"
                  width="24"
                  height="24"
        ...
        <div class="px-2 pr-14">
          ...
          <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Update member next of kin details to keep profile up-to-date.
          </p>
        </div>
        <div x-data="{
          currentStep: 1,
    ...
    <div x-show="makeDepositModal" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999">
      ...
      <div @click.outside="makeDepositModal = false" class="flex no-scrollbar relative w-full max-w-[700px] flex-col overflow-y-auto rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-11">
        ...
        <div class="px-2 pr-14">
          ...
          <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Specify contribution amount and status.
          </p>
        </div>
        <form class="flex flex-col">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-6">
                  ...
                  <div class="mb-8">
                    <div class="mb-4 md:mb-0">
                      <h4 class="text-normal font-bold text-gray-600 dark:text-white/90 mb-2">Sarah Kamau</h4>
                      <div class="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                        <p class="text-sm text-gray-500 dark:text-gray-400">sarah.k@example.com</p>
                        <div class="hidden h-3.5 w-px bg-gray-300 xl:block dark:bg-gray-700"></div>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                          +254 700 000 000
                        </p>
    ...
    <div x-show="verifyPaymentModal" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999">
      <div class="modal-close-btn fixed inset-0 h-full w-full bg-gray-400/50 backdrop-blur-[32px]"></div>
      <div @click.outside="verifyPaymentModal = false" class="flex no-scrollbar relative w-full max-w-[700px] flex-col overflow-y-auto rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-11">
        <!-- close btn -->
        <button @click="verifyPaymentModal = false"
                class="transition-color absolute right-5 top-5 z-999 flex h-11 w-11 items-center justify-center rounded-full bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-gray-600 dark:bg-gray-700 dark:bg-white/[0.05] dark:text-gray-400 dark:hover:bg-white/[0.07] dark:hover:text-gray-300">
          <svg
                  class="fill-current"
                  width="24"
        ...
        <div class="px-2 pr-14">
          ...
          <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Verify Pending Transaction details.
          </p>
        </div>
        <form class="flex flex-col">
          <div class="custom-scrollbar flex-1 overflow-y-auto px-6">
            ...
            <!-- Change Appointment Details Section -->
            <div class="space-y-6 mt-8">
              <h5 class="text-lg font-medium text-gray-600 dark:text-white/90 mb-6">Transaction Details</h5>
    ...
    <div x-show="addAssetModal" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999">
      <div class="modal-close-btn fixed inset-0 h-full w-full bg-gray-400/50 backdrop-blur-[32px]"></div>
      <div @click.outside="addAssetModal = false" class="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        <!-- close btn -->
        <button @click="addAssetModal = false" class="transition-color absolute right-5 top-5 z-999 flex h-11 w-11 items-center justify-center rounded-full bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-gray-600 dark:bg-gray-700 dark:bg-white/[0.05] dark:text-gray-400 dark:hover:bg-white/[0.07] dark:hover:text-gray-300">
          <svg
                  class="fill-current"
                  width="24"
                  height="24"
        ...
        <div class="px-2 pr-14">
          <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">Add New Vehicle</h4>
          <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">Provide rider vehicle details</p>
        </div>
        <div x-data="{
          currentStep: 1,
          steps: [
            { id: 1, title: 'Vehicle Details', completed: false },
            { id: 2, title: 'Technical Specs', completed: false },
            { id: 3, title: 'Registration', completed: false },
            { id: 4, title: 'Preview', completed: false }
          ],
          goToStep(step) {
            if (step >= 1 && step <= this.steps.length) {
        ...
        >
          ...
          <form class="flex flex-col">
            <div class="custom-scrollbar h-[450px] overflow-y-auto px-2">
              ...
              <!-- Step 1: General Vehicle Details -->
              <div x-show="currentStep === 1">
                <div class="mt-7">
                  <h5 class="mb-5 text-lg font-medium text-gray-800 dark:text-white/90 lg:mb-6">General Vehicle Details</h5>

                  <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                    <!-- Type (Motorcycle/TukTuk only) -->
                    <div class="col-span-2 lg:col-span-1">
                      <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Type</label>
                      <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                        <select class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" :class="isOptionSelected && 'text-gray-800 dark:text-white/90'" @change="isOptionSelected = true">
                          <option value="" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Select Type</option>
                          <option value="motorcycle" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Motorcycle</option>
                          <option value="tuktuk" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">TukTuk</option>
                        </select>
                        <span class="absolute top-1/2 right-4 z-30 -translate-y-1/2 text-gray-700 dark:text-gray-400">
                  <svg class="stroke-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.79175 7.396L10.0001 12.6043L15.2084 7.396" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    ...
                    <div class="col-span-2 lg:col-span-1">
                      ...
                      <input type="text" placeholder="e.g., Honda, Yamaha, Bajaj"
                    ...
                    <div class="col-span-2 lg:col-span-1">
                      ...
                      <input type="text" placeholder="e.g., CG125, RX100, RE200"
                             class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"/>
                    </div>
                    ...
                    <div class="col-span-2 lg:col-span-1">
                      ...
                      <input type="text" placeholder="e.g., Honda, TVS, Piaggio"
                             class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"/>
                    </div>

                    <!-- Year of Manufacture (YoM) -->
                    <div class="col-span-2 lg:col-span-1">
                      <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Year of Manufacture</label>
                      <div class="relative">
                        <input type="number" min="1900" max="2025" placeholder="e.g., 2023"
                               class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 pl-4 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"/>
                        <span class="absolute top-1/2 right-3 -translate-y-1/2 text-gray-500 dark:text-gray-400">
                  <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M6.66659 1.5415C7.0808 1.5415 7.41658 1.87729 7.41658 2.2915V2.99984H12.5833V2.2915C12.5833 1.87729 12.919 1.5415 13.3333 1.5415C13.7475 1.5415 14.0833 1.87729 14.0833 2.2915V2.99984L15.4166 2.99984C16.5212 2.99984 17.4166 3.89527 17.4166 4.99984V7.49984V15.8332C17.4166 16.9377 16.5212 17.8332 15.4166 17.8332H4.58325C3.47868 17.8332 2.58325 16.9377 2.58325 15.8332V7.49984V4.99984C2.58325 3.89527 3.47868 2.99984 4.58325 2.99984L5.91659 2.99984V2.2915C5.91659 1.87729 6.25237 1.5415 6.66659 1.5415ZM6.66659 4.49984H4.58325C4.30711 4.49984 4.08325 4.7237 4.08325 4.99984V6.74984H15.9166V4.99984C15.9166 4.7237 15.6927 4.49984 15.4166 4.49984H13.3333H6.66659ZM15.9166 8.24984H4.08325V15.8332C4.08325 16.1093 4.30711 16.3332 4.58325 16.3332H15.4166C15.6927 16.3332 15.9166 16.1093 15.9166 15.8332V8.24984Z" fill=""></path>
                  </svg>
              ...
              <div x-show="currentStep === 2">
                <div class="mt-7">
                  <h5 class="mb-5 text-lg font-medium text-gray-800 dark:text-white/90 lg:mb-6">Technical Specifications</h5>

                  <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                    <!-- CC (Engine Capacity) -->
                    <div class="col-span-2 lg:col-span-1">
                      <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Engine Capacity (CC)</label>
                      <input type="number" min="0" step="10" placeholder="e.g., 125, 150, 200"
                             class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"/>
                    </div>

                    <!-- Fuel Type -->
                    <div class="col-span-2 lg:col-span-1">
                      <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Fuel Type</label>
                      <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                        <select class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" :class="isOptionSelected && 'text-gray-800 dark:text-white/90'" @change="isOptionSelected = true">
                          <option value="" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Select Fuel Type</option>
                          <option value="petrol" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Petrol</option>
                          <option value="diesel" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Diesel</option>
                          <option value="electric" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Electric</option>
                          <option value="hybrid" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Hybrid</option>
                        </select>
                        <span class="absolute top-1/2 right-4 z-30 -translate-y-1/2 text-gray-700 dark:text-gray-400">
                  <svg class="stroke-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.79175 7.396L10.0001 12.6043L15.2084 7.396" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
              ...
              <!-- Step 3: Registration(Compliance) Information -->
              <div x-show="currentStep === 3">
                <div class="mt-7">
                  <h5 class="mb-5 text-lg font-medium text-gray-800 dark:text-white/90 lg:mb-6">Registration & Compliance Information</h5>

                  <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                    <!-- Plate Number -->
                    <div class="col-span-2 lg:col-span-1">
                      <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Plate Number</label>
                      <input type="text" placeholder="e.g., KMC 123A, KMT 456B"
                             class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"/>
                    </div>

                    <!-- Driving License Type -->
                    <div class="col-span-2 lg:col-span-1">
                      <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Driving License Type</label>
                      <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                        <select class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" :class="isOptionSelected && 'text-gray-800 dark:text-white/90'" @change="isOptionSelected = true">
                          <option value="" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Select License Type</option>
                          <option value="A" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Class A (Motorcycle)</option>
                          <option value="B" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Class B (Light Vehicle)</option>
                          <option value="C" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Class C (Commercial)</option>
                          <option value="D" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Class D (Heavy Vehicle)</option>
                        </select>
                        <span class="absolute top-1/2 right-4 z-30 -translate-y-1/2 text-gray-700 dark:text-gray-400">
                  <svg class="stroke-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.79175 7.396L10.0001 12.6043L15.2084 7.396" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    ...
                    <!-- NTSA Compliant -->
                    <div class="col-span-2 lg:col-span-1">
                      <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">NTSA Compliant</label>
                      <div class="flex space-x-6">
                        <div class="flex items-center">
                          <input id="ntsa-yes" type="radio" name="ntsa" value="yes" class="h-4 w-4 border-gray-300 text-brand-500 focus:ring-brand-500 dark:border-gray-600 dark:bg-gray-800 dark:focus:ring-brand-500">
                          <label for="ntsa-yes" class="ml-2 text-sm text-gray-700 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center">
                          <input id="ntsa-no" type="radio" name="ntsa" value="no" class="h-4 w-4 border-gray-300 text-brand-500 focus:ring-brand-500 dark:border-gray-600 dark:bg-gray-800 dark:focus:ring-brand-500">
                          <label for="ntsa-no" class="ml-2 text-sm text-gray-700 dark:text-gray-300">No</label>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- Insurance -->
                    <div class="col-span-2 lg:col-span-1">
                      <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Insurance Status</label>
                      <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                        <select class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" :class="isOptionSelected && 'text-gray-800 dark:text-white/90'" @change="isOptionSelected = true">
                          <option value="" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Select Insurance Status</option>
                          <option value="active" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Active</option>
                          <option value="expired" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Expired</option>
                          <option value="pending" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Pending</option>
                          <option value="none" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">No Insurance</option>
                        </select>
                        <span class="absolute top-1/2 right-4 z-30 -translate-y-1/2 text-gray-700 dark:text-gray-400">
                  <svg class="stroke-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.79175 7.396L10.0001 12.6043L15.2084 7.396" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
              ...
              <div x-show="currentStep === 4">
                <div class="mt-7">
                  <h5 class="mb-5 text-lg font-medium text-gray-800 dark:text-white/90 lg:mb-6">Registration Preview</h5>

                  <!-- Preview Sections -->
                  <div class="space-y-6">
                    <!-- Vehicle Details Preview -->
                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800/50">
                      <h5 class="mb-4 font-medium text-gray-700 dark:text-gray-300">Vehicle Details</h5>
                      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                          <p class="text-sm text-gray-500 dark:text-gray-400">Type</p>
                          <p class="text-sm font-medium text-gray-800 dark:text-gray-200" id="preview-type">-</p>
                        </div>
                        <div>
                          <p class="text-sm text-gray-500 dark:text-gray-400">Make & Model</p>
                          <p class="text-sm font-medium text-gray-800 dark:text-gray-200" id="preview-make-model">-</p>
                        </div>
                        <div>
                          <p class="text-sm text-gray-500 dark:text-gray-400">Brand</p>
                          <p class="text-sm font-medium text-gray-800 dark:text-gray-200" id="preview-brand">-</p>
                        </div>
                        <div>
                          <p class="text-sm text-gray-500 dark:text-gray-400">Year of Manufacture</p>
                          <p class="text-sm font-medium text-gray-800 dark:text-gray-200" id="preview-yom">-</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800/50">
                      <h5 class="mb-4 font-medium text-gray-700 dark:text-gray-300">Technical Specifications</h5>
                      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                          <p class="text-sm text-gray-500 dark:text-gray-400">Engine Capacity</p>
                          <p class="text-sm font-medium text-gray-800 dark:text-gray-200" id="preview-cc">-</p>
                        </div>
                        <div>
                          <p class="text-sm text-gray-500 dark:text-gray-400">Fuel Type</p>
                          <p class="text-sm font-medium text-gray-800 dark:text-gray-200" id="preview-fuel">-</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800/50">
                      <h5 class="mb-4 font-medium text-gray-700 dark:text-gray-300">Registration & Compliance</h5>
                      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                          <p class="text-sm text-gray-500 dark:text-gray-400">Plate Number</p>
                          <p class="text-sm font-medium text-gray-800 dark:text-gray-200" id="preview-plate">-</p>
                        </div>
                        <div>
                          <p class="text-sm text-gray-500 dark:text-gray-400">Driving License Type</p>
                          <p class="text-sm font-medium text-gray-800 dark:text-gray-200" id="preview-license">-</p>
                        </div>
                        <div>
                          <p class="text-sm text-gray-500 dark:text-gray-400">NTSA Compliant</p>
                          <p class="text-sm font-medium text-gray-800 dark:text-gray-200" id="preview-ntsa">-</p>
                        </div>
                        <div>
                          <p class="text-sm text-gray-500 dark:text-gray-400">Insurance Status</p>
                          <p class="text-sm font-medium text-gray-800 dark:text-gray-200" id="preview-insurance">-</p>
                        </div>
                      </div>
                    </div>
                  </div>
