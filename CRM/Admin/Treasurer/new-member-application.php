...
<html lang="en">
  ...
  <body x-data="{ page: 'profile', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false, 'updateKinModal': false, 'loanPaymentModal': false, 'withdrawContributionModal': false, 'awardLoanModal': false, 'isModalOpen': false, 'deactivateAccountModal': false, 'makeDepositModal': false,  'isProfileInfoModal': false,  'isProfileAddressModal': false,  'isProfileContactModal': false, 'isProfileNextKinModal': false, 'isProfileGuarantorModal': false,  'isProfileFinancialModal': false, 'isProfileAddVehicleModal': false}"
      ...
      <div class="relative flex flex-1 flex-col overflow-x-hidden overflow-y-auto">
        ...
        <main>
          <div class="mx-auto max-w-(--breakpoint-2xl) p-4 pb-20 md:p-6 md:pb-6">
            <!-- Breadcrumb Start -->
            <div x-data="{ pageName: `New Member Application`}">
              <div class="flex flex-wrap items-center justify-between gap-3 pb-6">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90" x-text="pageName"></h2>
                <nav>
                  <ol class="flex items-center gap-1.5">
                    <li>
                      <a class="inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400" href="bodaboda.php">Bodaboda Dashboard
                        <svg
                  ...
                  <div class="flex w-full flex-col items-center gap-6 xl:flex-row">
                    ...
                    <div class="order-3 xl:order-2">
                      ...
                      <div class="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                        <p class="text-sm text-gray-500 dark:text-gray-400">New Applicant No: #LA001</p>
                          ...
                          <tr>
                            ...
                            <td class="px-6 py-4">
                              <div class="flex items-center gap-3">
                                <button class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" @click="updateKinModal = true">
                                  <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="w-full ">
                  <div class="-mx-2.5 flex flex-wrap gap-y-5">
                    ...
                    <div class="w-full px-2.5 xl:w-1/2">
                      ...
                      <input type="text" placeholder="National ID number" class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
                    </div>
                    <!-- 5. Date of Birth -->
                    <div class="w-full px-2.5 xl:w-1/2">
                      <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
    ...
    <div x-show="isProfileNextKinModal" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999">
      ...
      <div @click.outside="isProfileNextKinModal = false" class="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        ...
        <div class="px-2 pr-14">
          ...
          <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Add member next of kin.
          </p>
        </div>

        <div class="flex relative">
          <form action="new-member-application.php" method="post">
            <div class="-mx-2.5 flex flex-wrap gap-y-5">
                    <div class="w-full px-2.5">
    ...
    <div x-show="updateKinModal" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999">
      <div class="modal-close-btn fixed inset-0 h-full w-full bg-gray-400/50 backdrop-blur-[32px]"></div>
      <div @click.outside="updateKinModal = false" class="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        <!-- close btn -->
        <button @click="updateKinModal = false" class="transition-color absolute right-5 top-5 z-999 flex h-11 w-11 items-center justify-center rounded-full bg-gray-100 text-gray-400 hover:bg-gray-200 hover:text-gray-600 dark:bg-gray-700 dark:bg-white/[0.05] dark:text-gray-400 dark:hover:bg-white/[0.07] dark:hover:text-gray-300">
          <svg
                  class="fill-current"
                  width="24"
                  height="24"
        ...
        <div class="px-2 pr-14">
          ...
          <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Update member next of kin details
          </p>
        </div>
    ...
    <div x-show="loanPaymentModal" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999">
      ...
      <div @click.outside="loanPaymentModal = false" class="flex no-scrollbar relative w-full max-w-[700px] flex-col overflow-y-auto rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-11">
        ...
        <div class="px-2 pr-14">
          ...
          <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Specify amount and payment type.
          </p>
        </div>
        <form class="flex flex-col">
          <div class="custom-scrollbar flex-1 overflow-y-auto px-6">
            ...
            <div class="space-y-6 mt-8">
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <div class="relative z-20 bg-transparent">
                    <select class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" :class="isOptionSelected &amp;&amp; 'text-gray-800 dark:text-white/90'">
                      <option class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Type</option>
                      <option value="Contribution" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Contribution</option>
                      <option value="Membership" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Membership</option>
                    </select>
                    <span class="pointer-events-none absolute top-1/2 right-4 z-30 -translate-y-1/2 text-gray-700 dark:text-gray-400">
                    <svg class="stroke-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M4.79175 7.396L10.0001 12.6043L15.2084 7.396" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                ...
                <div>
                  ...
                  <div class="relative z-20 bg-transparent">
                    <select class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" :class="isOptionSelected &amp;&amp; 'text-gray-800 dark:text-white/90'">
                      <option class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Method</option>
    ...
    <div x-show="awardLoanModal" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999">
      ...
      <div @click.outside="awardLoanModal = false" class="flex no-scrollbar relative w-full max-w-[700px] flex-col overflow-y-auto rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-11">
        ...
        <div class="px-2 pr-14">
          ...
          <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Specify the amount and payment type.
          </p>
        </div>
        <form class="flex flex-col">
          <div class="custom-scrollbar flex-1 overflow-y-auto px-6">
            ...
            <div class="space-y-6 mt-8">
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <div class="relative z-20 bg-transparent">
                    <select class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" :class="isOptionSelected &amp;&amp; 'text-gray-800 dark:text-white/90'">
                      <option value="confirm" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" selected="">Type</option>
                      <option value="Contribution" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Contribution</option>
                      <option value="Membership" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Membership Fee</option>
                    </select>
                    <span class="pointer-events-none absolute top-1/2 right-4 z-30 -translate-y-1/2 text-gray-700 dark:text-gray-400">
                    <svg class="stroke-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M4.79175 7.396L10.0001 12.6043L15.2084 7.396" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                ...
                <div>
                  ...
                  <div class="relative z-20 bg-transparent">
                    <select class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" :class="isOptionSelected &amp;&amp; 'text-gray-800 dark:text-white/90'">
                      <option value="confirm" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" selected="">Method</option>
                      <option value="Cash" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Cash</option>
                      <option value="MPesa" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">MPesa</option>
                    </select>
                    <span class="pointer-events-none absolute top-1/2 right-4 z-30 -translate-y-1/2 text-gray-700 dark:text-gray-400">
