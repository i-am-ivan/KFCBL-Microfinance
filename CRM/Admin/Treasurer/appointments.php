...
<html lang="en">
  ...
  <head>
    ...
    <title>Appointments | KFBCL - Mircofinance</title>

    <link rel="icon" href="../../../assets/favicon.ico">
    <link href="../../../assets/style.css" rel="stylesheet">
  </head>

  <body x-data="{ page: 'appointments', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false,  'newAppointmentModal': false, 'rescheduleModal': false, 'isProfileAddressModal': false }"
        x-init="
            ...
            <div class="space-y-6">
                ...
                <article class="flex items-center gap-5 rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/3">
                  ...
                  <div>
                    ...
                    <p class="flex items-center gap-3 text-gray-500 dark:text-gray-400">
                      All Appointments
                      <span class="bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500 inline-flex items-center justify-center gap-1 rounded-full px-2.5 py-0.5 text-sm font-medium">+20%</span>
                    </p>
                  </div>
                </article>
              ...
              <div class="grid grid-cols-12 gap-4 md:gap-6">
                ...
                <div class="col-span-12 xl:col-span-12">
                  <!-- Table -->
                  <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]" x-data="transactionTableFull()">
    ...
    <!-- BEGIN MODALS -->
    <!-- New Appointment -->
    <div x-show="newAppointmentModal" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999">
      <div class="modal-close-btn fixed inset-0 h-full w-full bg-gray-400/50 backdrop-blur-[32px]"></div>
      <div @click.outside="newAppointmentModal = false"
           class="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        <!-- close btn -->
        <button @click="newAppointmentModal = false"
        ...
        <div x-data="appointmentWizard()" class="flex flex-col h-full">
          <!-- Progress Bar -->
          <div class="mb-8 px-4 sm:px-6">
            ...
            <div class="flex justify-between text-sm text-gray-500 dark:text-gray-400">
              <span :class="{'text-brand-600 dark:text-brand-400 font-medium': currentStep >= 1}">Applicant Information</span>
                ...
                <div class="space-y-6">
                  <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="text" placeholder="Enter your full name" x-model="applicant.name"
                    ...
                    <div>
                      ...
                      <input type="email" placeholder="Enter your email" x-model="applicant.email"
                             class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                             required />
                    </div>
                    ...
                    <div>
                      ...
                      <input type="tel" placeholder="+254 700 000 000" x-model="applicant.phone"
                             class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                             required />
                    </div>
                    ...
                    <div>
                      ...
                      <input type="text" placeholder="Company name (optional)" x-model="applicant.company"
                             class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div class="mb-6">
                  ...
                  <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                    <select x-model="appointment.type" @change="isOptionSelected = true"
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                            :class="isOptionSelected && 'text-gray-800 dark:text-white/90'" required>
                      <option value="" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Select Appointment Type</option>
                      <option value="consultation" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Consultation Meeting</option>
                      <option value="review" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Document Review</option>
                      <option value="signing" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Document Signing</option>
                      <option value="interview" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Job Interview</option>
                      <option value="training" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Training Session</option>
                      <option value="presentation" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Client Presentation</option>
                      <option value="followup" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Follow-up Meeting</option>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                  ...
                  <div>
                    ...
                    <div class="relative">
                      <div class="flatpickr-wrapper">
                        <input type="text" placeholder="Select date" x-model="appointment.date"
                  ...
                  <div>
                    ...
                    <div class="relative">
                      <input type="time" x-model="appointment.time"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                  ...
                  <div>
                    ...
                    <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                      <select x-model="appointment.priority" @change="isOptionSelected = true"
                              class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-6">
                  ...
                  <div class="mb-8">
                    <div class="mb-4 md:mb-0">
                      <h4 class="text-normal font-bold text-gray-600 dark:text-white/90 mb-2"
                          x-text="applicant.name || 'Applicant Name'">
                        John Mwangi
                      </h4>
                      <div class="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                        <p class="text-sm text-gray-500 dark:text-gray-400" x-text="applicant.email || 'email@example.com'">
                          john@example.com
                        </p>
                        <div class="hidden h-3.5 w-px bg-gray-300 xl:block dark:bg-gray-700"></div>
                        <p class="text-sm text-gray-500 dark:text-gray-400" x-text="applicant.phone || '+254 700 000 000'">
                          +254 700 000 000
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <div class="flex items-center gap-2">
                          ...
                          <p class="font-medium text-gray-500 dark:text-white/90">
                            <span x-text="appointment.date || 'Not selected'">15 Dec, 2024</span>
                            <span x-show="appointment.time"> at <span x-text="appointment.time">10:30 AM</span></span>
                          </p>
                        </div>
                      </div>
                      <!-- Priority -->
                      ...
                      <div>
                        ...
                        <div class="flex items-center gap-3">
                          <p class="font-medium text-gray-500 dark:text-white/90" :class="{
                            ...
                            }" x-text="appointment.priority ? appointment.priority.charAt(0).toUpperCase() + appointment.priority.slice(1) : 'Normal'">
                            Normal
                          </p>
                        </div>
                      </div>
          ...
          <div class="flex items-center justify-between px-6 pt-4 pb-6 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="flex items-center gap-3">
              ...
              <button type="button" 
                      @click="newAppointmentModal = false"
              ...
              <button type="button" x-show="currentStep === 3" onclick="window.location.href='appointments.php'"
    ...
    <div x-show="rescheduleModal" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999">
      <div class="modal-close-btn fixed inset-0 h-full w-full bg-gray-400/50 backdrop-blur-[32px]"></div>
      <div @click.outside="rescheduleModal = false" class=" relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        ...
        <form class="flex flex-col" action="appointments.php" method="POST">
          <div class="custom-scrollbar flex-1 overflow-y-auto px-6">
            <!-- Preview Report View (unchanged design) -->
            <div class="space-y-6">
              <div x-data="{ selectedRow: {} }"
                   @row-selected.window="selectedRow = $event.detail"
                   x-init="selectedRow = {}">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-6">
                  ...
                  <div class="mb-8">
                    <div class="mb-4 md:mb-0">
                      <h4 class="text-normal font-bold text-gray-600 dark:text-white/90 mb-2"
                          x-text="selectedRow.applicantName || 'John Mwangi'">
                      </h4>
                      <div class="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                        <p class="text-sm text-gray-500 dark:text-gray-400"
                           x-text="selectedRow.applicantEmail || 'john@example.com'">
                        </p>
                        <div class="hidden h-3.5 w-px bg-gray-300 xl:block dark:bg-gray-700"></div>
                        <p class="text-sm text-gray-500 dark:text-gray-400" x-text="selectedRow.applicantPhone || 'Consultation Meeting'">
                          +254 700 000 000
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="flex items-center gap-6">
                      ...
                      <div>
                        <div>
                          <p class="text-sm text-gray-500 dark:text-gray-400 mb-2">Appointment Type</p>
                          <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-600 dark:bg-gray-900/30 dark:text-gray-400"
                                x-text="selectedRow.appointmentType || 'Consultation Meeting'">
                        </span>
                        </div>
                      </div>
                      <!-- Date & Time -->
                      ...
                      <div>
                        <div>
                          ...
                          <p class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-600 dark:bg-gray-900/30 dark:text-gray-400"
                             x-text="(selectedRow.priority ? selectedRow.priority.charAt(0).toUpperCase() + selectedRow.priority.slice(1) : 'Normal')">
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    <div class="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <div class="flex items-center gap-2">
                          <p class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-600 dark:bg-gray-900/30 dark:text-gray-400">
                            <span x-text="selectedRow.appointmentDate || '15 Dec, 2024'"> </span>
                            <span>  at <span x-text="selectedRow.appointmentTime || '10:30 AM'"></span></span>
                          </p>
                        </div>
                      </div>
                      <div class="w-px bg-gray-200 h-11 dark:bg-gray-800"></div>
                      <div>
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium"
                              ...
                              x-text="selectedRow.status || 'Confirmed'">
                    </span>
                      </div>
                    </div>
                  </div>
            ...
            <div class="space-y-6 mt-8">
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <div class="relative">
                    <div class="flatpickr-wrapper">
                      <input type="text" placeholder="Select new date"
                             class="dark:bg-dark-900 datepickerTwo shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 flatpickr-input"
                             readonly="readonly" value="15 Dec, 2024">
                    </div>
                    <span class="pointer-events-none absolute top-1/2 right-3 -translate-y-1/2 text-gray-500 dark:text-gray-400">
                      <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M6.66659 1.5415C7.0808 1.5415 7.41658 1.87729 7.41658 2.2915V2.99984H12.5833V2.2915C12.5833 1.87729 12.919 1.5415 13.3333 1.5415C13.7475 1.5415 14.0833 1.87729 14.0833 2.2915V2.99984L15.4166 2.99984C16.5212 2.99984 17.4166 3.89527 17.4166 4.99984V7.49984V15.8332C17.4166 16.9377 16.5212 17.8332 15.4166 17.8332H4.58325C3.47868 17.8332 2.58325 16.9377 2.58325 15.8332V7.49984V4.99984C2.58325 3.89527 3.47868 2.99984 4.58325 2.99984L5.91659 2.99984V2.2915C5.91659 1.87729 6.25237 1.5415 6.66659 1.5415ZM6.66659 4.49984H4.58325C4.30711 4.49984 4.08325 4.7237 4.08325 4.99984V6.74984H15.9166V4.99984C15.9166 4.7237 15.6927 4.49984 15.4166 4.49984H13.3333H6.66659ZM15.9166 8.24984H4.08325V15.8332C4.08325 16.1093 4.30711 16.3332 4.58325 16.3332H15.4166C15.6927 16.3332 15.9166 16.1093 15.9166 15.8332V8.24984Z" fill=""></path>
              ...
              <div class="mb-6">
                ...
                <div class="relative z-20 bg-transparent">
                  <select class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                          :class="isOptionSelected && 'text-gray-800 dark:text-white/90'">
                    <option value="confirm" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400" selected>Confirm</option>
                    <option value="cancel" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Cancel</option>
                    <option value="done" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Done</option>
                  </select>
                  <span class="pointer-events-none absolute top-1/2 right-4 z-30 -translate-y-1/2 text-gray-700 dark:text-gray-400">
                    <svg class="stroke-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M4.79175 7.396L10.0001 12.6043L15.2084 7.396" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <div class="flex justify-end items-center gap-3 pt-6 border-t border-gray-200 dark:border-gray-700 mt-8">
              ...
              <button class="h-11 rounded-lg border border-brand-500 bg-brand-500 px-6 text-sm font-semibold text-white shadow-theme-xs hover:bg-brand-600 disabled:pointer-events-none disabled:opacity-50">
    ...
    <script>
      function transactionTableFull() {
        return {
          // Original data with phone numbers added
          originalRows: [
            {
              id: 1,
              referenceId: "APT-2024-001",
              applicantName: "John Mwangi",
              applicantEmail: "john.m@example.com",
              applicantPhone: "+254 712 345 678",
              appointmentType: "Consultation Meeting",
              appointmentDate: "15 Dec, 2024",
              appointmentTime: "10:30 AM",
              subject: "Safaricom PLC",
              priority: "high",
              status: "Confirmed",
            },
            {
              id: 2,
              referenceId: "APT-2024-002",
              applicantName: "Sarah Kamau",
              applicantEmail: "sarah.k@example.com",
            ...
            {
              id: 3,
              referenceId: "APT-2024-003",
              applicantName: "David Ochieng",
              applicantEmail: "david.o@example.com",
              applicantPhone: "+254 734 567 890",
              appointmentType: "Follow-up Meeting",
              appointmentDate: "17 Dec, 2024",
              appointmentTime: "11:00 AM",
              subject: "Co-operative Bank",
              priority: "low",
              status: "Completed",
            },
            {
              id: 4,
              referenceId: "APT-2024-004",
              applicantName: "Grace Akinyi",
              applicantEmail: "grace.a@example.com",
              applicantPhone: "+254 745 678 901",
              appointmentType: "Client Presentation",
              appointmentDate: "18 Dec, 2024",
            ...
            {
              id: 5,
              referenceId: "APT-2024-005",
              applicantName: "Michael Odhiambo",
              applicantEmail: "michael.o@example.com",
              applicantPhone: "+254 756 789 012",
              appointmentType: "Training Session",
              appointmentDate: "19 Dec, 2024",
            ...
            {
              id: 6,
              referenceId: "APT-2024-006",
              applicantName: "Lucy Wanjiku",
              applicantEmail: "lucy.w@example.com",
              applicantPhone: "+254 767 890 123",
              appointmentType: "Job Interview",
              appointmentDate: "20 Dec, 2024",
              appointmentTime: "1:30 PM",
              subject: "Bamburi Cement",
              priority: "high",
              status: "Cancelled",
            },
            {
              id: 7,
              referenceId: "APT-2024-007",
              applicantName: "Peter Njoroge",
              applicantEmail: "peter.n@example.com",
              applicantPhone: "+254 778 901 234",
              appointmentType: "Document Review",
              appointmentDate: "21 Dec, 2024",
              appointmentTime: "10:00 AM",
              subject: "Absa Bank Kenya",
              priority: "normal",
              status: "Confirmed",
            },
            {
              id: 8,
              referenceId: "APT-2024-008",
              applicantName: "Esther Atieno",
              applicantEmail: "esther.a@example.com",
              applicantPhone: "+254 789 012 345",
              appointmentType: "Consultation Meeting",
              appointmentDate: "22 Dec, 2024",
              appointmentTime: "4:00 PM",
              subject: "East African Breweries Ltd",
              priority: "urgent",
              status: "Pending",
            },
            {
              id: 9,
              referenceId: "APT-2024-009",
              applicantName: "James Kariuki",
              applicantEmail: "james.k@example.com",
              applicantPhone: "+254 790 123 456",
              appointmentType: "Follow-up Meeting",
            ...
            {
              id: 10,
              referenceId: "APT-2024-010",
              applicantName: "Mary Wambui",
              applicantEmail: "mary.w@example.com",
            ...
            {
              id: 11,
              referenceId: "APT-2024-011",
              applicantName: "Robert Mwenda",
              applicantEmail: "robert.m@example.com",
              applicantPhone: "+254 702 345 678",
              appointmentType: "Document Signing",
              appointmentDate: "26 Dec, 2024",
              appointmentTime: "10:00 AM",
              subject: "Nation Media Group",
              priority: "high",
              status: "Pending",
            },
            {
              id: 12,
              referenceId: "APT-2024-012",
              applicantName: "Susan Chebet",
              applicantEmail: "susan.c@example.com",
              applicantPhone: "+254 703 456 789",
              appointmentType: "Training Session",
              appointmentDate: "27 Dec, 2024",
              appointmentTime: "9:30 AM",
              subject: "Stanbic Bank Kenya",
              priority: "normal",
              status: "Confirmed",
            },
            {
              id: 13,
              referenceId: "APT-2024-013",
              applicantName: "Brian Onyango",
              applicantEmail: "brian.o@example.com",
              applicantPhone: "+254 704 567 890",
              appointmentType: "Consultation Meeting",
            ...
            {
              id: 14,
              referenceId: "APT-2024-014",
              applicantName: "Faith Auma",
              applicantEmail: "faith.a@example.com",
              applicantPhone: "+254 705 678 901",
              appointmentType: "Follow-up Meeting",
              appointmentDate: "29 Dec, 2024",
            ...
            {
              id: 15,
              referenceId: "APT-2024-015",
              applicantName: "Samuel Gitau",
              applicantEmail: "samuel.g@example.com",
              applicantPhone: "+254 706 789 012",
              appointmentType: "Job Interview",
              appointmentDate: "30 Dec, 2024",
              appointmentTime: "11:00 AM",
              subject: "Centum Investment",
              priority: "high",
              status: "Pending",
            },
            {
              id: 16,
              referenceId: "APT-2024-016",
              applicantName: "Joyce Njeri",
              applicantEmail: "joyce.n@example.com",
              applicantPhone: "+254 707 890 123",
              appointmentType: "Document Review",
            ...
            {
              id: 17,
              referenceId: "APT-2024-017",
              applicantName: "Daniel Omondi",
              applicantEmail: "daniel.o@example.com",
              applicantPhone: "+254 708 901 234",
              appointmentType: "Client Presentation",
              appointmentDate: "3 Jan, 2025",
              appointmentTime: "2:00 PM",
              subject: "Kenya Power",
              priority: "urgent",
              status: "Pending",
            ...
            {
              id: 18,
              referenceId: "APT-2024-018",
              applicantName: "Patricia Adhiambo",
              applicantEmail: "patricia.a@example.com",
              applicantPhone: "+254 709 012 345",
              appointmentType: "Consultation Meeting",
              appointmentDate: "4 Jan, 2025",
              appointmentTime: "4:30 PM",
              subject: "Diamond Trust Bank",
              priority: "normal",
              status: "Confirmed",
            },
            {
              id: 19,
              referenceId: "APT-2024-019",
              applicantName: "Kevin Maina",
              applicantEmail: "kevin.m@example.com",
              applicantPhone: "+254 710 123 456",
              appointmentType: "Document Signing",
              appointmentDate: "5 Jan, 2025",
              appointmentTime: "9:00 AM",
              subject: "None",
              priority: "high",
              status: "Completed",
            ...
            {
              id: 20,
              referenceId: "APT-2024-020",
              applicantName: "Naomi Wairimu",
              applicantEmail: "naomi.w@example.com",
              applicantPhone: "+254 711 234 567",
              appointmentType: "Training Session",
              appointmentDate: "6 Jan, 2025",
              appointmentTime: "1:30 PM",
              subject: "NCBA Bank",
              priority: "normal",
              status: "Confirmed",
          ...
          // Get filtered rows based on search and filter
          get filteredRows() {
    ...
    <script>
      document.addEventListener('alpine:init', () => {
        ...
        Alpine.data('appointmentWizard', () => ({
          ...
          selectAppointmentForReschedule(row) {
            ...
            console.log('Appointment selected for rescheduling:', this.selectedAppointment);

            // You can pre-fill the rescheduling form with this data if needed
          ...
          // Helper method to format priority display
        ...
        // Global event handler for reschedule clicks
        Alpine.data('rescheduleHandler', () => ({
          // This method should be called when reschedule button is clicked
          handleRescheduleClick(row) {
            // Dispatch an Alpine event with the row data
            this.$dispatch('appointment-selected', row);

            // Open the modal (assuming you have a modal variable)
            if (typeof this.rescheduleModal !== 'undefined') {
              this.rescheduleModal = true;
            }

            // You can also directly update the appointment wizard component
            // if it's in the same Alpine scope
            const wizardComponent = this.$el.closest('[x-data]')?.__x.$data;
            if (wizardComponent && wizardComponent.selectAppointmentForReschedule) {
              wizardComponent.selectAppointmentForReschedule(row);
            }
      ...
      // Global event listener for handling reschedule clicks
      document.addEventListener('DOMContentLoaded', function() {
        // Listen for clicks on reschedule buttons
        document.addEventListener('click', function(event) {
          const rescheduleButton = event.target.closest('button');
          if (rescheduleButton && rescheduleButton.textContent.trim() === 'Reschedule') {
            // Find the closest table row
            const tableRow = rescheduleButton.closest('tr');
            if (tableRow) {
              // Extract data from the row (this is a fallback method)
              const rowData = extractRowData(tableRow);

              // Dispatch a custom event with the row data
              const rowSelectedEvent = new CustomEvent('appointment-row-selected', {
                detail: rowData,
                bubbles: true
              });
              document.dispatchEvent(rowSelectedEvent);

              console.log('Reschedule clicked for row:', rowData);
            }
          }
        });

        // Helper function to extract data from table row
        function extractRowData(row) {
          const cells = row.querySelectorAll('td');
          return {
            referenceId: cells[0]?.querySelector('a')?.textContent?.trim() || '',
            applicantName: cells[1]?.querySelector('span')?.textContent?.trim() || '',
            applicantEmail: cells[1]?.querySelector('p')?.textContent?.trim() || '',
            appointmentType: cells[2]?.querySelector('span')?.textContent?.trim() || '',
            appointmentDate: cells[3]?.querySelector('p')?.textContent?.trim() || '',
            appointmentTime: cells[3]?.querySelectorAll('p')[1]?.textContent?.trim() || '',
            subject: cells[4]?.querySelector('p')?.textContent?.trim() || '',
            priority: cells[5]?.querySelector('span')?.textContent?.trim()?.toLowerCase() || 'normal',
            status: cells[6]?.querySelector('span')?.textContent?.trim() || 'Pending'
          };
        }

        // Listen for the custom event
        document.addEventListener('appointment-row-selected', function(event) {
          const rowData = event.detail;
          console.log('Row selected via event:', rowData);

          // Here you can update your modal with the row data
          // This would depend on how your modal is implemented
          updateModalWithRowData(rowData);
        });

        function updateModalWithRowData(rowData) {
          // This function would update your modal elements
          // You'll need to adjust selectors based on your actual modal structure

          // Example:
          // const modalName = document.querySelector('[x-text*="selectedAppointment.applicantName"]');
          // if (modalName) modalName.textContent = rowData.applicantName;

          console.log('Modal should be updated with:', rowData);
        }
      });
    </script>
  </body>
