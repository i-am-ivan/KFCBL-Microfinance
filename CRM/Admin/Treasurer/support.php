...
<html lang="en">
  ...
  <head>
    ...
    <title>Support Tickets | KFBCL - Mircofinance</title>

    <link rel="icon" href="../../../assets/favicon.ico">
    <link href="../../../assets/style.css" rel="stylesheet">
  </head>

  <body x-data="{ page: 'profile', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false,  'newVehicleModal': false, 'editVehicleModal': false, 'isProfileAddressModal': false }"
        x-init="
        ...
        <div class="relative flex flex-1 flex-col overflow-x-hidden overflow-y-auto">
              ...
              <div :class="menuToggle ? 'flex' : 'hidden'"
                ...
                <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                  <a class="flex items-center text-gray-700 dark:text-gray-400" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                    <span class="mr-3 h-11 w-11 overflow-hidden rounded-full"><img src="../../../assets/src/images/user/owner.png" alt="User" /></span>
                  ...
                  <div x-show="dropdownOpen" class="shadow-theme-lg dark:bg-gray-dark absolute right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 dark:border-gray-800">
                    <div>
                      <span class="text-theme-sm block font-medium text-gray-700 dark:text-gray-400">Kamau Njunge</span>
                      <span class="text-theme-xs mt-0.5 block text-gray-500 dark:text-gray-400">
                        <a href="../../../cdn-cgi/l/email-protection.php" class="__cf_email__" data-cfemail="6113000f050e0c141204132111080c0b0e4f020e0c">[email&#160;protected]</a>
                      </span>
                    </div>

                    <ul class="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3 dark:border-gray-800">
                      <li>
                        <a href="profile.php" class="group text-theme-sm flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                          <svg
          ...
          <main>
            <div class="mx-auto max-w-(--breakpoint-2xl) p-4 pb-20 md:p-6 md:pb-6">
              <!-- Breadcrumb Start -->
              <div x-data="{ pageName: `Support Tickets` }">
              ...
              <div>
                ...
                <div class="mb-6 grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3">
                  <article class="flex gap-5 rounded-xl border border-gray-200 bg-white p-4 shadow-xs dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="flex-1">
                      <h3
                        class="text-title-xs mb-1 font-semibold text-gray-800 dark:text-white/90"
                      >
                        347
                      </h3>
                  ...
                  <div class="flex h-full flex-col gap-6 xl:flex-row xl:gap-5">
                    ...
                    <div @click.outside="isMobile = !isMobile" class="flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white xl:flex xl:w-1/4 dark:border-gray-800 dark:bg-white/[0.03]">
                      ...
                      <div class="sticky px-4 pt-4 pb-4 sm:px-5 sm:pt-5 xl:pb-0">
                        <div class="pb-5">
                          <button class="flex w-full items-center justify-center gap-2 rounded-lg bg-brand-500 p-3 text-sm font-medium text-white shadow-theme-xs hover:bg-brand-600">
                            ...
                            <div class="flex cursor-pointer items-center gap-3 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-white/[0.03]">
                              <div class="w-full">
                                <div class="flex flex-col">
                                  <h5 class="text-base font-semibold text-gray-800 dark:text-white/90 mb-2">
                                    #TCT251227
                                  </h5>
